...
class Popup extends Component {
	...
	handleImage(type) {
		switch (type) {
			case 'Success': return require('../assets/popup/Success.png')
			case 'Danger': return require('../assets/popup/Error.png')
			case 'Warning': return require('../assets/popup/Warning.png')
		}
	}
